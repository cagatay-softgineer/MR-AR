...
namespace ARFishing.Teacher
{
    public class TeacherPanelController : MonoBehaviour
    {
        ...
        [SerializeField] Button m_StartQuizButton;
        ...
        void OnEnable()
        {
            ...
            if (m_StartQuizButton != null) m_StartQuizButton.onClick.AddListener(OnStartQuiz);
        ...
        void OnDisable()
        {
            ...
            if (m_StartQuizButton != null) m_StartQuizButton.onClick.RemoveListener(OnStartQuiz);
        ...
        void UpdateButtonVisibility(ActivityState state)
        {
            ...
            if (m_StartQuizButton != null)
                m_StartQuizButton.gameObject.SetActive(
        ...
        {
            if (m_Controller == null) return;
            var s = m_Controller.Current;
            if (s == ActivityState.Scanning || s == ActivityState.Viewing)
            {
                m_Controller.TryTransition(ActivityState.Quiz);
            }
        }
