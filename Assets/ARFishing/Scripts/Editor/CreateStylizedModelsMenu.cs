...
namespace ARFishing.Editor
{
    ...
    {
        const string MaterialsDir = "Assets/ARFishing/Content/Materials";
        const string PrefabsDir = "Assets/ARFishing/Content/Models";
        const string MeshesDir = "Assets/ARFishing/Content/Models/Meshes";
